...
namespace XML_Extractor.Models
{
    //Auto generated from the XML file with https://xmltocsharp.azurewebsites.net/
    public class XMLRace
    {
        ...
        public class Track
        {
            ...
            [XmlAttribute(AttributeName = "club")] public string Club { get; set; }
        ...
        public class Horse
        {
            ...
            [XmlElement(ElementName = "trainer")] public Trainer Trainer { get; set; }
            ...
            [XmlElement(ElementName = "colours")] public string Colours { get; set; }
            ...
            [XmlElement(ElementName = "jockey")] public Jockey Jockey { get; set; }
            [XmlElement(ElementName = "barrier")] public string Barrier { get; set; }
            ...
            [XmlAttribute(AttributeName = "age")] public string Age { get; set; }
            [XmlAttribute(AttributeName = "sex")] public string Sex { get; set; }
        ...
        public class Horses
        {
            [XmlElement(ElementName = "horse")] public List<Horse> Horse { get; set; }
        }
        ...
        public class Price
        {
            ...
            [XmlElement(ElementName = "horses")] public Horses Horses { get; set; }
        }
        ...
        public class Race
        {
            ...
            [XmlElement(ElementName = "distance")] public Distance Distance { get; set; }
            [XmlElement(ElementName = "horses")] public Horses Horses { get; set; }
            [XmlElement(ElementName = "prices")] public Prices Prices { get; set; }
        ...
        public class Races
        {
            [XmlElement(ElementName = "race")] public Race Race { get; set; }
        }
        ...
        public class Meeting
        {
            ...
            [XmlElement(ElementName = "track")] public Track Track { get; set; }

            [XmlElement(ElementName = "Meetingid")]
            public string Meetingid { get; set; }

            [XmlElement(ElementName = "races")] public Races Races { get; set; }
